...
huang = Senior.create!(name:"Huang", address:"88 Rue Lepic", city: "Paris", key_skill:"Le mandarin", user: benoit, age:89, summary:"你好, 我叫Huang, 74岁, 我是一名中文老师. 我教中文已经很多年了, 我很乐意和你分享我的知识. 我很喜欢结识新朋友, 希望很快见到你. Je serai ravi de vous apprendre le mandarin comme il se doit.")
...
igor = Senior.create!(name:"Igor", address:"19 Rue de Vaugirard", city: "Paris", key_skill:"Les échecs", user: benoit, age:81, summary:"Salut, moi c'est Igor, 81 ans, ancien champion d'échecs hongrois. Je suis toujours à la recherche de celui ou celle qui pourra me battre hehehe.")
...
margaret = Senior.create!(name:"Margaret", address:"82 Rue de la Convention", city: "Paris", key_skill:"Parler la langue de Shakespeare", user: benoit, age:76, summary:"Hello, I'm Margaret, 76 years old, I'm a retired English teacher. I've been teaching English for many years and I would love to share my knowledge with you. N'hésitez pas à me contacter pour un cours d'anglais.")
...
renee = Senior.create!(name:"Renée", address:"127 Rue Michel-Ange", city: "Paris", key_skill:"Prendre le train", user: benoit, age:76, summary:"Hello c'est Renée, 76 ans, j'ai toujours adoré prendre le train et voyager à travers l'Europe. Je serai heureuse de partager mes techniques de train hopping avec vous!")
