...
mireille = Senior.create!(name:"Mireille", address:"12 Rue de Rivoli", city: "Paris", key_skill:"Street Fighter", user: cedric, age:69, summary:"Coucou je suis Mireille, 69 ans, grande amatrice de street fighter et autres jeux vidéos violents. Je pratique la console de jeux depuis de nombreuses années donc attention à vous. Je suis très sociable et j'aime rencontrer de nouvelles personnes à détruire virtuellement. Allez salut!")
...
huang = Senior.create!(name:"Huang", address:"88 Rue Lepic", city: "Paris", key_skill:"Le mandarin", user: cedric, age:89, summary:"你好, 我叫Huang, 74岁, 我是一名中文老师. 我教中文已经很多年了, 我很乐意和你分享我的知识. 我很喜欢结识新朋友, 希望很快见到你. Je serai ravi de vous apprendre le mandarin comme il se doit.")
...
igor = Senior.create!(name:"Igor", address:"19 Rue de Vaugirard", city: "Paris", key_skill:"Les échecs", user: cedric, age:81, summary:"Salut, moi c'est Igor, 81 ans, ancien champion d'échecs hongrois. Je suis toujours à la recherche de celui ou celle qui pourra me battre hehehe.")
...
margaret = Senior.create!(name:"Margaret", address:"82 Rue de la Convention", city: "Paris", key_skill:"Parler la langue de Shakespeare", user: cedric, age:76, summary:"Hello, I'm Margaret, 76 years old, I'm a retired English teacher. I've been teaching English for many years and I would love to share my knowledge with you. N'hésitez pas à me contacter pour un cours d'anglais.")
...
renee = Senior.create!(name:"Renée", address:"127 Rue Michel-Ange", city: "Paris", key_skill:"Prendre le train", user: cedric, age:76, summary:"Hello c'est Renée, 76 ans, j'ai toujours adoré prendre le train et voyager à travers l'Europe. Je serai heureuse de partager mes techniques de train hopping avec vous!")
...
puts "crea bookings"
Booking.create(date: "01/06/2025", user: benoit, senior: rosalinda, datetime:"2025-06-01 13:00:00 UTC", status:"Confirmé")
Booking.create(date: "02/06/2025", user: benoit, senior: renee, datetime:"2025-03-28 09:45:00 UTC", status:"à confirmer")
Booking.create(date: "03/06/2025", user: benoit, senior: marie, datetime:"2025-03-21 11:00:00 UTC", status:"à confirmer")
Booking.create(date: "04/06/2025", user: sami, senior: pascal, datetime:"2025-04-01 09:00:00 UTC", status:"à confirmer")
Booking.create(date: "05/06/2025", user: sami, senior: marcelo, datetime:"2025-03-20 10:45:00 UTC", status:"Confirmé")
Booking.create(date: "06/07/2025", user: juliette, senior: pascal, datetime:"2025-05-05 14:00:00 UTC", status:"à confirmer")
Booking.create(date: "07/06/2025", user: juliette, senior: michel, datetime:"2025-03-24 17:00:00 UTC", status:"à confirmer")
Booking.create(date: "08/06/2025", user: cedric, senior: michel, datetime:"2025-03-24 14:00:00 UTC", status:"Confirmé")
# Booking.create(date: "09/06/2025", user: 1, senior_id: 5, datetime:"2025-03-28 23:45:00 UTC")
...
# Booking.create(date: "12/06/2025", user: 1, senior_id: 6, datetime:"2025-03-28 23:45:00 UTC")
# Booking.create(date: "13/06/2025", user: 1, senior_id: 7, datetime:"2025-03-28 23:45:00 UTC")
